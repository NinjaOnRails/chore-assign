Randomly assigns chores to people and emails them about it. Never gives the same assignment twice in a row for the same person. Creates and saves the last chore list in a txt file to keep track.
Usage:
